    ...
    <div class="container">
        ...
        <div class="portfolio-container">
            ...
            <a href="<?php echo $permalink ?>" class="box image<?php echo $loopIndex + 1 ?>">
                <div class="image"
                    style="background: url('<?php echo $image_properties['url']; ?>' ); height: 100%; width: 100%; background-size: cover ; background-position: center center ; background-repeat: no-repeat ;">
                    <div class="hover-bg">
                        <div class="title">
